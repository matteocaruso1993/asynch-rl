...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 19 16:18:16 2021
...
parser.add_argument("-e", "--epochs-training", dest = "n_epochs", type=int, default=  200,
                    help="Number of epochs per training iteration [QV].")

parser.add_argument("-mb", "--minibatch-size", dest="minibatch_size",  type=int, default= 512 ,
                    help="Size of the minibatches used for training QV")
...
parser.add_argument("-ro", "--reset-optimizer", dest="reset_optimizer", type=bool, default=False, help="reset optimizer")
...
def main(net_version = 0, n_iterations = 5, ray_parallelize = False, \
        ...
        gamma = 0.99, beta = 0.2, noise_factor = 0.01 , \
        continuous_qv_update = False, tot_iterations = 400):
