...
parser.add_argument("-a", "--agents-number", dest="agents_number", type=int, default=50,
...
def main(net_version = 0, n_iterations = 2, ray_parallelize = False,  difficulty = 0,\
    ...
    rl_env = Multiprocess_RL_Environment(env_type , model_type , net_version , rl_mode = rl_mode, \
                        ...
                        tot_iterations = single_agent_min_iterations, discr_env_bins = 2 , \
                        ...
                        pg_partial_update = pg_partial_update, \
